...
void main()
{
    ...
    *a1=0; *a2=0; *a3=0; *a4=0; *a5=0; *a6=0;
	...
	while (1)
	{
		...
		char namanya[10];
		int jumlahnya;
		printf("Masukkan senjata yang ingin dibeli: ");
		scanf("%s",namanya);
		scanf("%d",&jumlahnya);
		if (strcmp(namanya,"MP4A1")==0&&*a1>=jumlahnya) *a1-=jumlahnya;
		else if (strcmp(namanya,"PM2-V1")==0&&*a2>=jumlahnya) *a2-=jumlahnya;
		else if (strcmp(namanya,"SPR-3")==0&&*a3>=jumlahnya) *a3-=jumlahnya;
		else if (strcmp(namanya,"SS2-V5")==0&&*a4>=jumlahnya) *a4-=jumlahnya;
		else if (strcmp(namanya,"SPG1-V3")==0&&*a5>=jumlahnya) *a5-=jumlahnya;
		else if (strcmp(namanya,"MINE")==0&&*a6>=jumlahnya) *a6-=jumlahnya;
		else printf("Senjata tidak tersedia atau stok tidak cukup\n");
	    }
	}
    }
